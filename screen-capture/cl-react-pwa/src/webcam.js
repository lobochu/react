export class Webcam {
    ...
    _drawImage() {
        ...
        context.drawImage(this.webcamElement,
        100, 100,   // Start at 70/20 pixels from the left and the top of the image (crop),
        400, 200,   // "Get" a `50 * 50` (w * h) area from the source image (crop),
